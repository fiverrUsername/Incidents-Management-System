...
// const SLACK_API_TOKEN = 'xoxb-5609511342163-5604717800598-XAxj3F4jbNGLav6i5DkQZkJw';

// async function createNewChannel(channelName: string, userIds: string[]) {
//   try {
//     const response = await axios.post('https://slack.com/api/conversations.create', {
//       name: channelName,
//       is_private: false,
