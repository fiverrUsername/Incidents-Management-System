        ...
        <StyledPaper>
            <Grid container direction="row" justifyContent="center" alignItems="flex-start" flexWrap="nowrap">
                ...
                <Grid container direction="column" justifyContent="flex-start" alignItems="flex-start">
                    ...
                    {/* <CustomAutocomplete options={s} selectedOptions={selectedTags} setSelectedOptions={setSelectedTags} getOptionLabel={getOptionLabel}/> */}
                    {summaryIncident.tags.length!=0 &&<>
                    <Box style={{borderRadius: '10px' ,border: '1px solid'+ theme.palette.info.main,width:"100%",height:"50px", padding:"1.5% "}} >
