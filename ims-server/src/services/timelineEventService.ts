...
class TimelineEventService {
  async getAllTimelineEvents(): Promise<ITimelineEvent[] | any> {
    try {
      ...
      const timelineEvent =
        await timelineEventRepository.getAllTimelineEvents();
  ...
  async getTimelineEventByIncidentId(
    ...
    try {
      ...
      const timelineEvent =
        await timelineEventRepository.getTimelineEventByIncidentId(id);
  ...
  async updateTimelineEvent(
    ...
    try {
      ...
      return await timelineEventRepository.updateTimelineEvent(
        timeLineEventId,
        newTimelineEvent
      );
    } catch (error: any) {
  ...
  async getTimelineEventById(id: String): Promise<ITimelineEvent | any> {
    try {
      const _timelineEvent = await timelineEventRepository.getTimelineEventById(
        id
      );
      if (_timelineEvent) {
        logger.info({
  ...
  async getFileInTimelineEventByIndex(
    ...
    try {
      const timelineEvent: ITimelineEvent | null =
        await this.getTimelineEventById(id);
      ...
      logger.error({
        source: constants.TIMELINE_EVENT,
        err: constants.SERVER_ERROR,
        method: constants.METHOD.GET,
      });
      return new Error(
        `Error retrieving file in timeline event by index: ${error}`
      );
    }
  }
  ...
  async deleteFileInTimelineEventByIndex(
    ...
    try {
      ...
      return new Error(
        `Error deleting file in timeline event by index: ${error}`
      );
    }
  }
  ...
  async deleteFileInTimelineEventByValue(
    ...
    try {
      ...
      return new Error(
        `Error deleting file in timeline event by string file: ${error}`
      );
    }
  }
