...
const whitelist = ['wss://ims-socket.onrender.com/','wss://ims-socket-t.onrender.com','https://slack-server-71aw.onrender.com/','wss://ims-socket.onrender.com/8080','https://slack-server-71aw.onrender.com/4700','http://localhost:3000', 'http://localhost:4700', 'http://localhost:7071','http://localhost:7000'];
