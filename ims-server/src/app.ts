...
const whitelist = ['wcc://ims-socket.onrender.com/','https://slack-server-71aw.onrender.com/','http://localhost:3000', 'http://localhost:4700', 'http://localhost:7071','http://localhost:7000'];
